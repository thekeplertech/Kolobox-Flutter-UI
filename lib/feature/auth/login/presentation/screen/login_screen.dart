...
class LoginScreenState extends BaseBlocWidgetState<LoginScreen> {
  ...
  void initState() {
    ...
    if (FlavorConfig.isDev()) {
      emailTextEditingController.text = 'parth1234567891234567@mailinator.com';
    ...
    // emailTextEditingController.text = 'vjcworld@gmail.com';
    // passwordTextEditingController.text = 'Mylife@007';
  }
