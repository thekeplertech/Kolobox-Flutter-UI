...
class SelectFamilyWidget extends BaseScreen {
  ...
  @override
  State<SelectFamilyWidget> createState() => _SelectFamilyWidgetState();
}

class _SelectFamilyWidgetState extends BaseScreenState<SelectFamilyWidget> {
