...
class EnableRecurringDepositSummaryWidget extends BaseScreen {
  ...
  @override
  State<EnableRecurringDepositSummaryWidget> createState() =>
      _EnableRecurringDepositSummaryWidgetState();
}

class _EnableRecurringDepositSummaryWidgetState
    extends BaseScreenState<EnableRecurringDepositSummaryWidget> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Text(
          //   '${koloboxFundEnum.getFundValue} Sumary',
