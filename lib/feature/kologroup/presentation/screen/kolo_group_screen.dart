...
import 'package:kolobox_new_app/feature/kologroup/presentation/bloc/kolo_group_event.dart';
...
class KoloGroupScreenState extends BaseBlocWidgetState<KoloGroupScreen> {
  ...
  callGroup() => BlocProvider.of<KoloGroupBloc>(context).add(GetGroupEvent());
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Total Interest (${CurrencyTextInputFormatter.formatAmount(KoloboxFundEnum.koloGroup.getInterestRate(), isSymbol: false)}% p.a)',
                          ...
                          children: [
                            Text(
                              CurrencyTextInputFormatter.formatAmountDouble(
                                  KoloboxFundEnum.koloGroup.getInterest()),
                            ...
                            Text(
                              'Interest in ${KoloboxFundEnum.koloGroup.getTenor()} days',
  ...
  Widget getEmptyWidget(bool isActive) => Column(
        children: [
          ...
          Icon(
            KoloboxFundEnum.koloGroup.getFundIconValue,
            size: 60,
            color: KoloboxFundEnum.koloGroup.getFundIconColorValue,
          ),
          const SizedBox(
            height: 20,
          ),
